...
declare namespace filesystem {
    ...
    function readDirectory(path: string): Promise<any>;
    ...
    function getStats(path: string): Promise<any>;
}
declare namespace os {
    ...
    function execCommand(command: string, options?: ExecCommandOptions): Promise<any>;
    function getEnv(key: string): Promise<any>;
    function showOpenDialog(title?: string, options?: OpenDialogOptions): Promise<any>;
    function showFolderDialog(title?: string): Promise<any>;
    function showSaveDialog(title?: string, options?: SaveDialogOptions): Promise<any>;
    function showNotification(title: string, content: string, icon?: Icon): Promise<any>;
    function showMessageBox(title: string, content: string, choice?: MessageBoxChoice, icon?: Icon): Promise<any>;
...
declare namespace computer {
    function getMemoryInfo(): Promise<any>;
}
declare namespace storage {
    function setData(key: string, data: string): Promise<any>;
